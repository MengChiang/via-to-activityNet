...
class VideoProcessor:
    ...
    def process_video(self, filename):
        ...
        image_pairs, total_frames = self.extract_images(video_id, filename)
    ...
    def extract_images(self, video_id, video_path):
        ...
        for frame_number in range(0, total_frames, self.fps):
            real_time = frame_number / clip.fps
            img_path = os.path.join(images_path, f"{video_id}_{real_time}.jpg")
